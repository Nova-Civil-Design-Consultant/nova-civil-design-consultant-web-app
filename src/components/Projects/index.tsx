...
import constans from "../../constants/index.json";

const Projects = () => {
  const [categories, setCategories] = useState(constans?.document?.Projects_Component?.project_type_title);
  ...
  return (
    <div>
      <div className="w-full flex flex-col items-center justify-center gap-6 lg:mt-44 mt-20 lg:px-80 p-5">
        <SectionHeader
          title={constans?.document?.Projects_Component?.title}
          description={constans?.document?.Projects_Component?.description}
        />
        <div className="w-full flex items-center justify-between">
          ...
          <Button
            ...
            onClick={() => console.log(":::::CHECK1:::::")}
          >
            {constans?.document?.Projects_Component?.view_all_button}
          </Button>
        </div>
